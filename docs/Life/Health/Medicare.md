...
因为**城乡居民基本医疗保险**类型的医保，没有个人账户，不积累余额，只有统筹账户。在使用医保时，费用自动从统筹账户上扣除。
...
若新生**首次**办理参保缴费的，从**入学当年**的9月1日起即按规定提前享受相关待遇。

但由于信息导入延迟问题，如果需要报销，新生需保存好门诊就诊发票、转诊单等医疗凭证（包括校医院就医发票和转徐州市二级甲等以上公立医院就诊医疗凭据），在**第二学期**进行报销。

即：新生在入学当年9月到12月这段期间，你可以看病，但是需要先自费，第二学期再报销。
...
**甲类药品**：是指由国家统一制定的、临床治疗必需，使用广泛，疗效好，同类药物中价格低的药物。

**乙类药品**：是可供临床治疗选择使用、疗效好、同类药品中比甲类药品价格较高的药品。

**丙类药品**：是国家医保范围外的，比如进口药、特效药、保健药等。

**查询药物类别的方法**：支付宝**国家医保服务平台**小程序➡️药品分类与代码➡️输入药物名称查询即可
...
**不予报销的项目**：体检费、挂号诊查费、自费类、丙类药品、血液制品、预防性疫苗，材料费等。
